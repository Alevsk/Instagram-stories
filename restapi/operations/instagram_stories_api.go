...
func NewInstagramStoriesAPI(spec *loads.Document) *InstagramStoriesAPI {
	return &InstagramStoriesAPI{
		...
		UserAPIStoryCreateHandler: user_api.StoryCreateHandlerFunc(func(params user_api.StoryCreateParams) middleware.Responder {
...
func (o *InstagramStoriesAPI) Validate() error {
	...
	if o.UserAPIStoryCreateHandler == nil {
		unregistered = append(unregistered, "user_api.StoryCreateHandler")
	}
...
func (o *InstagramStoriesAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/stories"] = user_api.NewStoryCreate(o.context, o.UserAPIStoryCreateHandler)
}

// Serve creates a http handler to serve the API over HTTP
// can be used directly in http.ListenAndServe(":8000", api.Serve(nil))
func (o *InstagramStoriesAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
